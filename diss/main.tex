...
\includeonly{interactive_slicing}


\newacronym{afl}{AFL}{automated fault-localization}
...
Enterprise applications also often use a database to handle complex operations on large amounts of data.

...
\begin{abstract}
  Back-in-time debuggers allow developers to explore what happened before a failure and so supports them in finding failure causes more efficiently. 
	We present an approach for bringing back-in-time debugging to stored procedures that allows to step backwards and query the database at previous points in time.

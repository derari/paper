...
While there are several such debuggers for frontend or backend programming languages, we do not know of any back-in-time capabilities at the database-level.

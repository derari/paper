...
\tool\ runs in HANA's XS-Engine, a framework for web-applications that is part of the HANA platform.
...
Packaged as a XS Application, \tool\ can be easily installed in a HANA installation.

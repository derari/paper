...
Finally, we selected two complex queries from the stored procedures as examples for queries a developer might submit through the debugger's SQL console and measured their execution time both as a regular query and as a time-diff query.

...
\begin{itemize}
	...
	\item The \emph{Slice Navigator} is a UI component that bundles access to the debugger and the slicer.
		It provides context for the current instruction by showing relevant parts of the sliceinstruction, allows developers to modify the slicing criteria, and serves as an alternative to breakpoints and stepping.
